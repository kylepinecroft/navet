...
const DROPDOWN_MENU_SURFACE_ANIMATION_CLASSNAME =
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          DROPDOWN_MENU_SURFACE_ANIMATION_CLASSNAME,
          'z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] overflow-x-hidden overflow-y-auto p-1.5',
